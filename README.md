...
Welcome to **OptiGrain**. This repository houses the complete source code for the OptiGrain platform, featuring a robust Python-based backend and a modern TypeScript frontend.
